...
def start(update, context):
    start_string = f'''
Hi, I'm ParaBoy, a multipurpose bot for [ParaBoy](t.me/topglobal_epep)
Type /{BotCommands.HelpCommand} to get a list of available commands
'''
    update.effective_message.reply_photo("https://telegra.ph/file/820216b57a11a1f895c9c.jpg", start_string, parse_mode=ParseMode.MARKDOWN)
